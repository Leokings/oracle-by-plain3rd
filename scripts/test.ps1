...
$TestArtifactsDir = Join-Path ([System.IO.Path]::GetTempPath()) "truthfeed-gltest-artifacts"
...
try {
  ...
  & (Join-Path $TestVenvDir "Scripts\genvm-lint.exe") check contracts\truth_feed.py --json
